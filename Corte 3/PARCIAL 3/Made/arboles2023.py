...
class ArbolBinario:
    ...
    # Caso base: el nodo es None o el valor coincide
        if nodo is None or nodo.valor_nodo == valor:
            return nodo
    
    # Buscar en el subárbol izquierdo
        resultado_izquierdo = self.buscarNodo(nodo.hijo_izquierdo, valor)
        if resultado_izquierdo is not None:
            return resultado_izquierdo
    
    # Buscar en el subárbol derecho
        resultado_derecho = self.buscarNodo(nodo.hijo_derecho, valor)
